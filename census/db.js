...
//sum total population in each department
// citiesModel
//     .aggregate()
//     .group({
...
//Display average population by department
// citiesModel
//     .aggregate()
//     .group({
//         _id: {department: "$department"},
...
//Sort this info by population
// citiesModel
//     .aggregate()
//     // .sort ({population : 1 } ) //increasing order
//     .sort ({population : -1 } )  //decreasing order
//     .then((response) => console.log(response));


//count the number of city by department
// citiesModel
//     .aggregate()
//     .group({
//         _id: {department : "$department"},
...
// Get the same info but only for town starting  with  a P
// citiesModel
//     .aggregate()
//     .match({
//         city : /P/,
